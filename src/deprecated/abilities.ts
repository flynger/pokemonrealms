...
export const Abilities: {[abilityId: string]: AbilityEntry} = {
    "ADAPTABILITY": {
      "id": "ADAPTABILITY",
      "name": "Adaptability",
    ...
    "BLAZE": {
      "id": "BLAZE",
      "name": "Blaze",
      "desc": "At 1/3 or less of its max HP, this Pokemon's attacking stat is 1.5x with Fire attacks.",
      "num": 66,
      "rating": 2
    },
    "BULLETPROOF": {
    ...
    "INFILTRATOR": {
      "id": "INFILTRATOR",
      "name": "Infiltrator",
      "desc": "Moves ignore substitutes and foe's Reflect/Light Screen/Safeguard/Mist/Aurora Veil.",
      "num": 151,
      "rating": 3
    },
    "INNARDSOUT": {
    ...
    "OVERGROW": {
      "id": "OVERGROW",
      "name": "Overgrow",
      "desc": "At 1/3 or less of its max HP, this Pokemon's attacking stat is 1.5x with Grass attacks.",
      "num": 65,
      "rating": 2
    },
    "OWNTEMPO": {
    ...
    "STAKEOUT": {
      "id": "STAKEOUT",
      "name": "Stakeout",
      "desc": "This Pokemon's attacking stat is doubled against a target that switched in this turn.",
      "num": 198,
      "rating": 2.5
    },
    "STALL": {
    ...
    "STEELWORKER": {
      "id": "STEELWORKER",
      "name": "Steelworker",
      "desc": "This Pokemon's attacking stat is multiplied by 1.5 while using a Steel-type attack.",
      "num": 200,
      "rating": 3
    },
    "STENCH": {
    ...
    "SWARM": {
      "id": "SWARM",
      "name": "Swarm",
      "desc": "At 1/3 or less of its max HP, this Pokemon's attacking stat is 1.5x with Bug attacks.",
      "num": 68,
      "rating": 2
    },
    "SWEETVEIL": {
    ...
    "TORRENT": {
      "id": "TORRENT",
      "name": "Torrent",
      "desc": "At 1/3 or less of its max HP, this Pokemon's attacking stat is 1.5x with Water attacks.",
      "num": 67,
      "rating": 2
    },
    "TOXICBOOST": {
